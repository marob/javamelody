...
public class DelegatingGraphDatabase implements GraphDatabase {
    ...
    private volatile CypherQueryEngine cypherQueryEngine;
    ...
    @SuppressWarnings("unchecked")
    private CypherQueryEngine queryEngine(ResultConverter resultConverter, boolean reinit) {
    ...
    private CypherQueryEngine createCypherQueryEngine(ResultConverter resultConverter) {
